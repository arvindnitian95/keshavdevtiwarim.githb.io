...
table,tr,th{
  ...
  <br>
  <br>
<h1 style="color: red; margin-left: -900px " >UG programe</h1>
 ...
 <div class="column">
     ...
     <h1 style="color: white; height: 40px;background-color: blue">BA</h1>
   <div class="Profile">
     ...
     <table>
         ...
         <tr>
             <th>Eligibility</th>
             <td>Class XII with any stream (but mainly humanities) from a recognized board</td>
         </tr>
         <tr>
...
<div class="column">
  <div class="card">
     <h1 style="color: white;height: 40px;background-color: blue">BSC</h1>
   <div class="Profile">
...
<div class="column">
  <div class="card">
     <h1 style="color: white;height: 40px;background-color: blue;">B.el.ed</h1>
   <div class="Profile">
     <p style="color: black">We are committed to serving diverse needs of young & old, rich & poor & those living in urban & rural communities.</p>
     <br>
     <p style="color: black">Provision of excellent medical services by eminent, highly qualified doctors.</p><br>
