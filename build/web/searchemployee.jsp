...
.login-box a
{
    ...
    <body style="background-image: url(d1.jpg); background-size: cover; height: 700px">
        <header>
	...
	<div style="width: 850px; float: right; margin-top:0px"> 
     		...
     		<h6 style="color: black; margin-top: -150px;font-size: 20px;font-weight: bold;margin-left: -70px">Keshav Dev Tiwari Mahavidhyalay Gohan Jalaun U.P-285123</h6>
     		<h6 style="margin-top:-40px; color: black;font-size: 20px;font-weight: bold;margin-left: -70px">केशवदेव तिवारी महाविद्यालय गोहन जालौन,उत्तर प्रदेश-285123</h6>
     		<div class="h">
...
<div style="background-image: url(d1.jpg); background-size: cover;">        
 <div class="login-box" style="margin-top: 100px">
        <h2>Search Employee</h2>

           <form method="post" name="frm" action="Searchemployee">
             <p>Student Id</p>
